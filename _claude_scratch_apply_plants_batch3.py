...
NEW_SECTIONHUB = """import { Link } from 'react-router-dom';
...
with io.open(f"{ROOT}/src/pages/SectionHub.jsx", 'w', encoding='utf-8') as f:
    f.write(NEW_SECTIONHUB)
print("SectionHub.jsx rewritten")
