...
export const CATEGORIES = [
  ...
  { slug: 'grow-bags-containers', label: 'Grow Bags & Nursery Containers', tagline: 'Sturdy growing homes for seedlings and saplings', image: 'https://images.unsplash.com/photo-1459156212016-c812468e2115?q=80&w=800&auto=format&fit=crop' },
  ...
  { slug: 'irrigation-watering', label: 'Irrigation & Watering Equipment', tagline: 'Hoses, sprinklers and drip systems that keep watering effortless', image: 'https://images.unsplash.com/photo-1502394202744-021cfbb17454?q=80&w=800&auto=format&fit=crop' },
  { slug: 'plant-support', label: 'Plant Support Materials', tagline: 'Stakes, ties and trellis for plants that need a hand', image: 'https://images.unsplash.com/photo-1461354464878-ad92f492a5a0?q=80&w=800&auto=format&fit=crop' },
  { slug: 'hydroponic-supplies', label: 'Hydroponic Supplies', tagline: 'Soil-free growing gear for faster, cleaner harvests', image: 'https://images.unsplash.com/photo-1518241353330-0f7941c2d9b5?q=80&w=800&auto=format&fit=crop' },
  { slug: 'vertical-gardening', label: 'Vertical Gardening Accessories', tagline: 'Living walls and stacked planters for small spaces', image: 'https://images.unsplash.com/photo-1487530811176-3780de880c2d?q=80&w=800&auto=format&fit=crop' },
  { slug: 'lawn-landscaping', label: 'Lawn & Landscaping Materials', tagline: 'Mowers, edging and turf care for a full landscaping job', image: 'https://images.unsplash.com/photo-1502394202744-021cfbb17454?q=80&w=800&auto=format&fit=crop' },
  { slug: 'decorative-stones-mulch', label: 'Decorative Stones & Mulch', tagline: 'Pebbles, gravel and mulch to finish off any bed', image: 'https://images.unsplash.com/photo-1560717845-968823efbee1?q=80&w=800&auto=format&fit=crop' },
  { slug: 'shade-nets-covers', label: 'Shade Nets & Protective Covers', tagline: 'Netting and covers that protect plants from sun, frost and pests', image: 'https://images.unsplash.com/photo-1461354464878-ad92f492a5a0?q=80&w=800&auto=format&fit=crop' },
  { slug: 'smart-garden-tech', label: 'Smart Garden Tech', tagline: 'Sensors and app-connected tools for a smarter garden', image: 'https://images.unsplash.com/photo-1477414348463-c0eb7f1359b6?q=80&w=800&auto=format&fit=crop' },
