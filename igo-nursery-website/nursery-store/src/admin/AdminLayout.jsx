...
const NAV_ITEMS = [
  ...
  { to: '/admin/pages/garden-services', label: 'Garden Services', icon: LeafServiceIcon },
  { to: '/admin/pages/landscaping', label: 'Landscaping', icon: TreeIcon },
  { to: '/admin/pages/gifting', label: 'Gifting', icon: GiftIcon2 },
  { to: '/admin/pages/corporate-gifting', label: 'Corporate Gifting', icon: BuildingIcon },
  { to: '/admin/pages/blog', label: 'Blog', icon: BookIcon },
  { to: '/admin/pages', label: 'Pages', icon: FileIcon },
